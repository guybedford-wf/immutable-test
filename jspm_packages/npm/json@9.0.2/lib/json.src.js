...
(function(process) {
  var VERSION = '9.0.2';
  var p = console.warn;
  var util = require("github:jspm/nodelibs@0.0.5/util");
  var assert = require("github:jspm/nodelibs@0.0.5/assert");
  var path = require("github:jspm/nodelibs@0.0.5/path");
  var vm = require("github:jspm/nodelibs@0.0.5/vm");
  var fs = require("github:jspm/nodelibs@0.0.5/fs");
  var warn = console.warn;
  var EventEmitter = require("github:jspm/nodelibs@0.0.5/events").EventEmitter;
  exports.main = main;
  ...
  var json_parse = function() {
    ...
    var a,
        ...
        f = function(c) {
          return c && c !== b && e("Expected '" + c + "' instead of '" + b + "'"), b = d.charAt(a), a += 1, b;
        },
        g = function() {
          var a,
              c = "";
        ...
        m = function() {
          ...
          if (b === "{") {
            ...
            if (b === "}")
              return f("}"), c;
            while (b) {
              a = h(), i(), f(":"), Object.hasOwnProperty.call(c, a) && e('Duplicate key "' + a + '"'), c[a] = k(), i();
              if (b === "}")
                return f("}"), c;
              f(","), i();
            }
    ...
    return k = function() {
      ...
      var g;
      return d = c, a = 0, b = " ", g = k(), i(), b && e("Syntax error"), typeof f == "function" ? function h(a, b) {
        var c,
            d,
            e = a[b];
        if (e && typeof e == "object")
          for (c in e)
            Object.prototype.hasOwnProperty.call(e, c) && (d = h(e, c), d !== undefined ? e[c] = d : delete e[c]);
        return f.call(a, b, e);
      }({"": g}, "") : g;
    };
  }();
          ...
          switch (ch) {
            ...
            case ']':
              ...
              if (states[states.length - 1] === null) {
                var evaled = vm.runInNewContext('(' + bit.slice(1, -1) + ')', {}, '<lookup>');
                bits.push(evaled);
                bit = '';
              }
              break;
  ...
  function stringifyDatum(datum, opts, isTTY) {
    ...
    switch (opts.outputMode) {
      ...
      case OM_JSON:
        ...
        break;
      case OM_COMPACT:
        if (datum === undefined) {} else if (Array.isArray(datum)) {
          var bits = ['[\n'];
  ...
  function main(argv) {
    ...
    function parseChunk(chunk, obj, filename, inPlace, headers) {
      ...
      var i,
          j;
      if (!exe) {} else if (opts.array || (opts.array === null && Array.isArray(data))) {
      ...
      if (!cond) {} else if (opts.array || (opts.array === null && Array.isArray(data))) {
        var arrayified = false;
        if (!Array.isArray(data)) {
          arrayified = true;
          data = [data];
