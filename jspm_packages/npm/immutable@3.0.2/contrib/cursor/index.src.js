...
KeyedCursorPrototype.equals = IndexedCursorPrototype.equals = function(second) {
  return Immutable.is(this.deref(), second && (typeof second.deref === 'function' ? second.deref() : second));
};
KeyedCursorPrototype.deref = IndexedCursorPrototype.deref = function(notSetValue) {
  return this._rootData.getIn(this._keyPath, notSetValue);
};
KeyedCursorPrototype.get = KeyedCursorPrototype.getIn = IndexedCursorPrototype.get = IndexedCursorPrototype.getIn = function(key, notSetValue) {
...
KeyedCursorPrototype.cursor = IndexedCursorPrototype.cursor = function(subKey) {
...
function updateCursor(cursor, changeFn, changeKey) {
  var newRootData = cursor._rootData.updateIn(cursor._keyPath, changeKey ? Map() : undefined, changeFn);
